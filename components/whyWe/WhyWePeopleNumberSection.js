...
import WhyWeAboutListItem from "./WhyWeAboutListItem";
            ...
            <div className="row">
                <div className="col-md-6">
                    <div className="me-md-5">
                        ...
                        <p style={{marginTop: "60px"}}>Acının kendisi çok fazla acıdır Bu, ücretsiz ürünler,
                            atıştırmalıklar ve başka zamanı olmayanlar
                            içindir. Onu zevkle memnun etmek için, aradığı ve reddedilmesi gereken arasındaki ayrım asla
                            kör
